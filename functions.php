...
function pt_setup() {
	 ...
	 * to change 'pt' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'pt', get_template_directory() . '/languages' );
	...
	add_theme_support( 'custom-background', apply_filters( 'pt_custom_background_args', array(
...
function pt_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'pt_content_width', 640 );
}
...
function pt_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'pt' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'pt' ),
